  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-50 rounded-xl py-8 px-2 mb-10 shadow-md">
        <h1 className="text-4xl font-bold text-blue-800 mb-3 text-center">About Get Well Soon</h1>
      ...
      <div className="bg-green-50 rounded-xl px-4 py-6 mb-10 shadow-md">
        <h2 className="text-2xl font-semibold text-green-700 mb-2 text-center">Our Story</h2>
      ...
      {/* Team Grid */}
      <div className="mb-14">
        <h2 className="text-2xl font-semibold text-blue-700 mb-5 text-center">Our Team</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {teamMembers.map((member, idx) => (
            ...
            >
              ...
              <div className="text-lg font-bold text-blue-700 mb-1">{member.name}</div>
      ...
      {/* Chef Section */}
      <div className="mb-6">
        <h2 className="text-2xl font-semibold text-orange-700 mt-10 mb-4 text-center">Meet Our Chef</h2>
        <div className="flex justify-center">
          ...
          >
            ...
            />
            <div className="text-xl font-bold text-orange-700 mb-1">{chef.name}</div>
